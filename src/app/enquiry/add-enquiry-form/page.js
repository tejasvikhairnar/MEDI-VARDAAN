      ...
      <Card className="border-gray-200 dark:border-gray-800">
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Row 1: Enquiry No and Enquiry Date */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="enquiryNo" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  Enquiry No.
                </Label>
                <Input
                  id="enquiryNo"
                  ...
                  className="border-gray-300 dark:border-gray-700 bg-gray-100"
                  readOnly
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="enquiryDate" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  Enquiry Date
                </Label>
                <Input
                  id="enquiryDate"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="enquirySource" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  Enquiry Source <span className="text-red-500">*</span>
                </Label>
                <Select value={formData.enquirySource} onValueChange={(value) => handleInputChange("enquirySource", value)}>
                  <SelectTrigger className="border-gray-300 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="enquiryFor" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  Enquiry For <span className="text-red-500">*</span>
                </Label>
                <Select value={formData.enquiryFor} onValueChange={(value) => handleInputChange("enquiryFor", value)}>
                  <SelectTrigger className="border-gray-300 dark:border-gray-700">
